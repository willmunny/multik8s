...
kubectl set image deployments/client-deployment client=leandrosoares/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=leandrosoares/multi-worker:$SHA